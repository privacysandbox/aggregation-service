...
public final class LocalCredentialsProviderModule extends AbstractModule {
  ...
  @Singleton
  GoogleCredentials provideCoordinatorACredentials() throws IOException {
  ...
  @Singleton
  GoogleCredentials provideCoordinatorBCredentials() throws IOException {
    return GoogleCredentials.getApplicationDefault();
  }
}
