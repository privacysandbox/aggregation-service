...
/** Fake implementation of {@link EncryptionKeyService} for testing. */
public final class FakeEncryptionKeyService implements EncryptionKeyService {
  ...
  @Inject
  FakeEncryptionKeyService(KeysetHandle keysetHandle) {
