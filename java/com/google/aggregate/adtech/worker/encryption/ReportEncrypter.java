...
public interface ReportEncrypter {
  /** Generates a single EncryptedReport of specified reportVersion. */
  EncryptedReport encryptSingleReport(Report report, String reportVersion)
