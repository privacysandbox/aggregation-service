...
/** CLI enum to select the encrypted record reader */
enum RecordReaderSelector {
  ...
  RecordReaderSelector(Class<? extends RecordReaderFactory> factoryClass) {
    this.factoryClass = factoryClass;
  }

  Class<? extends RecordReaderFactory> getReaderFactoryClass() {
    return factoryClass;
  }
}
