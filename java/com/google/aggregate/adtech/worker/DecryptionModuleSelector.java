...
import com.google.aggregate.adtech.worker.decryption.noop.NoopDecryptionModule;

/** Selector for the decryption module */
public enum DecryptionModuleSelector {
  HYBRID(new HybridDecryptionModule()),
  NOOP(new NoopDecryptionModule());
