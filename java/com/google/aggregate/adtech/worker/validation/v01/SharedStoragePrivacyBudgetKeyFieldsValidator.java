...
/**
 * Validates that the Shared Storage API type report's SharedInfo fields used in Privacy Budget Key
 * generation are present and not null/empty.
 */
public class SharedStoragePrivacyBudgetKeyFieldsValidator implements PrivacyBudgetKeyValidator {
