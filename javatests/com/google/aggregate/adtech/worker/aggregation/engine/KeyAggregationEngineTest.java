...
public class KeyAggregationEngineTest {
  ...
  public void oneReportOneFact() {
    ...
    ImmutableMap<AggregationKey, AggregatedFact> aggregation = engine.makeAggregation();

    assertThat(aggregation)
        .containsExactly(
            AggregationKey.create(createBucketFromInt(1)),
  ...
  public void twoReportSameFactKey() {
    ...
    assertThat(aggregation)
        .containsExactly(
            AggregationKey.create(createBucketFromInt(2)),
  ...
  public void oneReportMultipleFacts() {
    ...
    assertThat(aggregation)
        .containsExactly(
            AggregationKey.create(createBucketFromInt(1)),
            AggregatedFact.create(createBucketFromInt(1), /* value= */ 7),
            AggregationKey.create(createBucketFromInt(2)),
            AggregatedFact.create(createBucketFromInt(2), /* value= */ 10));
  }
  ...
  public void multipleReportsMultipleFacts() {
    ...
    assertThat(aggregation)
        .containsExactly(
            ...
            AggregationKey.create(createBucketFromInt(2)),
            AggregatedFact.create(createBucketFromInt(2), /* value= */ 7),
            AggregationKey.create(createBucketFromInt(3)),
            AggregatedFact.create(createBucketFromInt(3), /* value= */ 10),
            AggregationKey.create(createBucketFromInt(4)),
  ...
  @Test
  public void getPrivacyBudgetKeyInputFromPrivacyBudgetUnit() {
    Report report1 =
        FakeReportGenerator.generateWithParam(
            1, SharedInfo.LATEST_VERSION, "https://origin1.foo.com");
    Report report2 =
        FakeReportGenerator.generateWithParam(
            2, SharedInfo.LATEST_VERSION, "https://origin1.foo.com");
    PrivacyBudgetKeyInput privacyBudgetKeyInputReport1 =
        PrivacyBudgetKeyInput.builder()
            .setFilteringId(FILTERING_ID_ZERO)
            .setSharedInfo(report1.sharedInfo())
            .build();
    PrivacyBudgetKeyInput privacyBudgetKeyInputReport2 =
        PrivacyBudgetKeyInput.builder()
            .setFilteringId(FILTERING_ID_ZERO)
            .setSharedInfo(report2.sharedInfo())
            .build();
    ImmutableList<PrivacyBudgetKeyInput> expectedPrivacyBudgetKeyInput =
        ImmutableList.of(privacyBudgetKeyInputReport1, privacyBudgetKeyInputReport2);

    engine.accept(report1);
    engine.accept(report2);
    ImmutableList<PrivacyBudgetUnit> privacyBudgetUnits = engine.getPrivacyBudgetUnits();
    ImmutableList<PrivacyBudgetKeyInput> privacyBudgetKeyInputImmutableList =
        engine.getPrivacyBudgetKeyInputsFromPrivacyBudgetUnits(privacyBudgetUnits);

    assertThat(privacyBudgetKeyInputImmutableList)
        .containsExactlyElementsIn(expectedPrivacyBudgetKeyInput);
  }

  @Test
  public void getPrivacyBudgetKeyInputFromPrivacyBudgetUnit_withFilteringIds() {
    UnsignedLong FILTERING_ID_1 = UnsignedLong.valueOf(1);
    UnsignedLong FILTERING_ID_2 = UnsignedLong.valueOf(2);
    ...
    Report report2 =
        FakeReportGenerator.generateWithParam(
            2, SharedInfo.LATEST_VERSION, "https://origin1.foo.com");
    PrivacyBudgetKeyInput privacyBudgetKeyInputReport1FilteringId1 =
        PrivacyBudgetKeyInput.builder()
            .setFilteringId(FILTERING_ID_1)
            .setSharedInfo(report1.sharedInfo())
            .build();
    PrivacyBudgetKeyInput privacyBudgetKeyInputReport1FilteringId2 =
        PrivacyBudgetKeyInput.builder()
            .setFilteringId(FILTERING_ID_2)
            .setSharedInfo(report1.sharedInfo())
            .build();
    PrivacyBudgetKeyInput privacyBudgetKeyInputReport2FilteringId1 =
        PrivacyBudgetKeyInput.builder()
            .setFilteringId(FILTERING_ID_1)
            .setSharedInfo(report2.sharedInfo())
            .build();
    PrivacyBudgetKeyInput privacyBudgetKeyInputReport2FilteringId2 =
        PrivacyBudgetKeyInput.builder()
            .setFilteringId(FILTERING_ID_2)
            .setSharedInfo(report2.sharedInfo())
            .build();
    ...
    ImmutableList<PrivacyBudgetKeyInput> expectedPrivacyBudgetKeyInput =
        ImmutableList.of(
            privacyBudgetKeyInputReport1FilteringId1,
            privacyBudgetKeyInputReport1FilteringId2,
            privacyBudgetKeyInputReport2FilteringId1,
            privacyBudgetKeyInputReport2FilteringId2);

    AggregationEngine engine =
        aggregationEngineFactory.createKeyAggregationEngine(
            /* filteringIds= */ ImmutableSet.of(FILTERING_ID_1, FILTERING_ID_2));
