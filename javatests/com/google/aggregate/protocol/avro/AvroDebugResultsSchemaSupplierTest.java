...
public class AvroDebugResultsSchemaSupplierTest {

  // Under test
  AvroDebugResultsSchemaSupplier avroResultsSchemaSupplier;

  @Before
  public void setUp() {
    avroResultsSchemaSupplier = new AvroDebugResultsSchemaSupplier();
  }
  ...
  public void testHasCorrectSchema() {
    ...
    assertThat(fieldNames).containsExactly("bucket", "unnoised_metric", "noise", "annotations");
  }
