...
GCS_URL="https://storage.googleapis.com/aggregation-service-published-artifacts/aggregation-service"

# Prebuilt jars to download - _{VERSION} will be postfix added
jars=(
  "FrontendServiceHttpCloudFunction"
  "WorkerScaleInCloudFunction"
  "LocalTestingTool"
)
...
for jar in "${jars[@]}"; do
  ...
  curl -f -o jars/${jar}_$VERSION.jar ${GCS_URL}/${VERSION}/${jar}_${VERSION}.jar
done
